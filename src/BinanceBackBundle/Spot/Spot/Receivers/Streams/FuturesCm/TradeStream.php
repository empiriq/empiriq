...
namespace Empiriq\BinanceBackBundle\Spot\Spot\Receivers\Streams\FuturesCm;
...
use DateTimeZone;
use Empiriq\BinanceBackBundle\Common\AbstractStream;
use Empiriq\BinanceBackBundle\Common\Helpers\CsvLoader;
use Empiriq\BinanceBackBundle\Common\Interfaces\CsvLoaderInterface;
...
class TradeStream extends AbstractStream implements FuturesCmStreamInterface
{
    /**
    ...
    protected function getUri(): Closure
    {
        return fn(DateTimeInterface $date) => "https://data.binance.vision/data/"
            . "futures/cm/daily/trades/{$this->symbol}/{$this->symbol}-trades-{$date->format('Y-m-d')}.zip";
    }
